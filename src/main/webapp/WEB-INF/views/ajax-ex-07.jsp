...
<body>
	...
	<script>
		// 자바스크립트 (ex-07: post 요청하기 & parameter DTO로 전달받기(@RequestBody) & DTO 객체 리턴하기))
		const ex07Fn = () => {
			...
			$.ajax({
				...
				contentType: "application/json", // 보낼때 json형식으로 보내는 방법이 가능하다. 컨트롤러에서 받을때 @RequestBody로 받을수있따
